...
most_popular_in_year <- function(year) {
  ...
  most_popular <- names_in_year[names_in_year$prop == max(names_in_year$prop), 'name']
}

# What was the most popular female name in 1994?
most_popular_in_19994 <- most_popular_in_year(1994)
